...
export default function LoginForm() {
    ...
    const onSubmit = (data) => {
        axios.post('http://localhost:8000/account/login', data,
            {
                headers: {
        ...
        <div className="flex justify-center">
            <div className="flex flex-col w-2/5 gap-5 border py-5">
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 px-10">
                    {error &&
                        <div className="flex justify-center text-error text-md rounded border border-error p-2 text-center">⚠ {error} ⚠</div>
                    }
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="self-end underline text-xs cursor-pointer">Forgot your password?</div>
